...
resource "aws_ssm_parameter" "mongodb_admin_password" {
  name  = "/${var.environment}/${var.ssm_parameter}/ADMIN_PASSWORD"
  type  = "SecureString"
  value = random_string.autogenerated_password.result
}
resource "aws_ssm_parameter" "mongodb_admin_user" {
  name  = "/${var.environment}/${var.ssm_parameter}/ADMIN_USER"
  type  = "String"
  value = "${var.mongo_username}"
}
resource "aws_ssm_parameter" "mongodb_admin_db" {
  name  = "/${var.environment}/${var.ssm_parameter}/ADMIN_DB"
  type  = "String"
  value = "${var.mongo_database}"
}
resource "aws_ssm_parameter" "primary_mongodb_domain" {
  name = "/${var.environment}/${var.ssm_parameter}/PRIMARY_DB_ENDPOINT"
  type  = "String"
  value = "primary.${var.domain_name}"
}
resource "aws_ssm_parameter" "secondary_mongodb_domain" {
  count = "${var.num_secondary_nodes}"
  name = "/${var.environment}/${var.ssm_parameter}/SECONDARY_DB_ENDPOINT_${count.index}"
  type  = "String"
  value = "secondary${count.index}.${var.domain_name}"
}
